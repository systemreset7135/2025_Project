...
public final class Constants {
  public static final class OIConstants {
    public static final boolean kDoublePlayer = true;
    public static final int kDriverControllerPort = 0;
    public static final int kDriverControllerPortSec = 1;
    public static final double kDriveDeadband = 0.05;
    public static final int kDriverIntakeButtonIndex = 7;
    public static final int kDriverShootButtonIndex = 8;
  ...
  public static final class DriveConstants {
    ...
    public static final double kAngleOffset = 10;
  ...
  public static class ClimberConstants {
    public static final int kLeftActuatorPort = 0;
    public static final int kRightActuatorPort = 1;
    public static final double kLiftSpeed = 1;
    public static final double kDropSpeed = 1;
    public static final double kStartAutoLiftTime = 90;
    public static final double kAutoLiftDuration = 20;
  }
  public static class LimelightConstants {
    public static final double kMaximumDistance = 73;
    public static final double kLeftMargin = 60;
    public static final double kRightMargin = 60;
    public static final double kMinimumDistance = 79;
    public static final double kBlueTagID = 7;
    public static final double kRedTagID = 4;
  }
}
